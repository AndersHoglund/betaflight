...
typedef enum {
    ...
    SERVO_DUALCOPTER_FRONT = 4,
    SERVO_DUALCOPTER_REAR = 5,
...
#define SERVO_DUALCOPTER_INDEX_MIN SERVO_DUALCOPTER_FRONT
#define SERVO_DUALCOPTER_INDEX_MAX SERVO_DUALCOPTER_REAR
